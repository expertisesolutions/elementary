 ...
 */
extern const Eo_Event_Description _ELM_MODEL_TREE_CONST_SELECTED_EVT;
#define ELM_MODEL_TREE_CONST_SELECTED_EVT (&(_ELM_MODEL_TREE_CONST_SELECTED_EVT))

extern const Eo_Event_Description _ELM_MODEL_TREE_CONST_CHILD_APPENDED_EVT;
#define ELM_MODEL_TREE_CONST_CHILD_APPENDED_EVT (&(_ELM_MODEL_TREE_CONST_CHILD_APPENDED_EVT))

extern const Eo_Event_Description _ELM_MODEL_TREE_CONST_DELETED_EVT;
#define ELM_MODEL_TREE_CONST_DELETED_EVT (&(_ELM_MODEL_TREE_CONST_DELETED_EVT))

extern const Eo_Event_Description _ELM_MODEL_TREE_CONST_VALUE_SET_EVT;
#define ELM_MODEL_TREE_CONST_VALUE_SET_EVT (&(_ELM_MODEL_TREE_CONST_VALUE_SET_EVT))
